...
namespace App2
{
    ...
    /// </summary>
    public sealed partial class Consult : Page
    {
        ...
        private async void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                string response = await httpClient.GetStringAsync(
                    new Uri(Statistics.ServerLink +"addConsult.php?d="+description.Text+"&random="+random.Next().ToString()));
                var dialog_catch = new MessageDialog("Your message has been sent,Going back to the main menu.");
